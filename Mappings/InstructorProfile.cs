...
namespace FAP_BE.Mappings
{
    public class InstructorProfile : Profile
    {
        ...
        {
            CreateMap<Instructor, InstructorInfoDTO>().MaxDepth(2)
                .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.MetaData.Name))
                .ForMember(dest => dest.Dob, opt => opt.MapFrom(src => src.MetaData.Dob))
                ...
                .ForMember(dest => dest.Password, opt => opt.MapFrom(src => src.MetaData.Account.Password))
